...
contract PhantasmManager {
    ...
    address private immutable DInterest = 0x6D97eA6e14D35e10b50df9475e9EFaAd1982065E;
    ...
    */
    ...
    function closeLongPosition(uint256 _tokenID, uint8 _swapImplementation, uint256 _interestAccured) public {
            // Check removed for now require(ownerOf(_tokenID) == msg.sender, "You have to own something to get it's value");
...
*/
    function openInsulatedLongPositionNFT(
        ...
        bondImplementation(bondImplementations[0]).buyYieldTokens(DInterest, _depositId, stableFundAmount);
